...
showButtonNext();}}}}
function paintLetters(){profG=profG+78; var leV=0;var toV=profG;for (i = 0; i < fillLetter.length; i++) {
...
leV=leV+48;if (leV+48>actMaxWidth){leV=0;toV=toV+48;}}
var heiAct=(toV+48).toString()+"px";$("#ardoraAct").css("height",heiAct);
...
contexto.fillRect(0, 0, canvas.width, canvas.height);contexto.font = "18px " + fMenssage;
var metricsW = contexto.measureText(textBNext).width;var x = canvas.width - metricsW -50 ;var y = canvas.height-18-40;
...
roundedRect(contexto, x, y, metricsW+45,18+20, 5, colorButton);contexto.shadowColor = "black";contexto.shadowBlur = 15;
...
contexto.fillText(textBNext,x+10,y+18+10);contexto.lineWidth=5;contexto.stroke();contexto.fill();
